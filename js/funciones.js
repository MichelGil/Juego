//Variables globales
let imgN1 = [
    {nombre:"Ariel", url:"img/Ariel.jpg"},
    {nombre:"Amarillo", url:"img/Amarillo.jpg"},
    {nombre:"Bella", url:"img/Bella.jpg"},
    {nombre:"Niño", url:"img/Niño.jpg"},
    {nombre:"Rosa", url:"img/Rosa.jpg"},
    {nombre:"Verde", url:"img/Verde.jpg"},
    {nombre:"Ariel", url:"img/Ariel.jpg"},
    {nombre:"Amarillo", url:"img/Amarillo.jpg"},
    {nombre:"Bella", url:"img/Bella.jpg"},
    {nombre:"Niño", url:"img/Niño.jpg"},
...
let imgN2 = [
    ...
    {nombre:"Rosa", url:"img/Rosa.jpg"},
    {nombre:"Verde", url:"img/Verde.jpg"},
    {nombre:"Yasmin", url:"img/Yasmin.jpg"},
    {nombre:"Tiana", url:"img/Tiana.jpg"},
    {nombre:"Ariel", url:"img/Ariel.jpg"},
    {nombre:"Amarillo", url:"img/Amarillo.jpg"},
    {nombre:"Bella", url:"img/Bella.jpg"},
    {nombre:"Niño", url:"img/Niño.jpg"},
...
let imgN3 = [
    ...
    {nombre:"Yasmin", url:"img/Yasmin.jpg"},
    {nombre:"Tiana", url:"img/Tiana.jpg"},
    {nombre:"moana", url:"img/moana.jpg"},
    {nombre:"Rapunzel", url:"img/Rapulzel.jpg"},
    {nombre:"moana", url:"img/moana.jpg"},
    {nombre:"Rapunzel", url:"img/Rapulzel.jpg"}
...
function compararImagenes() {
    ...
    if (imagenNombre[0]== imagenNombre[1]){
        if (imagenID[0] !=imagenID[1]){
            ...
            sonidoAdivinar.play();
            imagenesTablero[imagenID[0]].src = "img/Acertaste.jpg"; //mostrar ok cuando la persona gana
            imagenesTablero[imagenID[1]].src = "img/Acertaste.jpg";
            ...
            imagenesTablero[imagenID[0]].src = "img/Ocultar.jpg";
            intentos++
       ...
       // alert("Fallaste, las imágenes son diferentes");
        sonidoFallar.play();
        imagenesTablero[imagenID[0]].src = "img/Ocultar.jpg";  //ocultar de nuevo cuando la persona falla
        imagenesTablero[imagenID[1]].src = "img/Ocultar.jpg";
        intentos++
        mostrarIntentos.textContent = intentos;
    }
